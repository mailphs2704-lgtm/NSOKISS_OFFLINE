...
//    }
    ...
    public void initRandomItem() {
        ...
        itemsRecFromCoinItem.add(50, ItemName.GAY_MAT_TRANG);
        itemsRecFromCoinItem.add(50, ItemName.GAY_TRAI_TIM);
        ...
        itemsRecFromCoinItem.add(10, ItemName.RUONG_BACH_NGAN);
        itemsRecFromCoinItem.add(20, ItemName.RUONG_HUYEN_BI);
        itemsRecFromCoinItem.add(30, ItemName.BAT_BAO);
        ...
        itemsRecFromCoinItem.add(50, ItemName.HOA_TUYET);
        itemsRecFromCoinItem.add(50, ItemName.PHA_LE);
        itemsRecFromCoinItem.add(50, ItemName.NHAM_THACH_);
        itemsRecFromCoinItem.add(80, ItemName.THE_BAI_KINH_NGHIEM_GIA_TOC_SO);
        itemsRecFromCoinItem.add(80, ItemName.THE_BAI_KINH_NGHIEM_GIA_TOC_TRUNG);
        itemsRecFromCoinItem.add(50, ItemName.DA_CAP_8);
        itemsRecFromCoinItem.add(50, ItemName.DA_CAP_9);
        ...
        itemsRecFromCoinItem.add(0.001, ItemName.TUI_VAI_CAP_3);
        ...
        itemsRecFromCoinItem.add(0.001, ItemName.HOAN_LUONG_CHI_THAO);
        itemsRecFromCoinItem.add(0.001, ItemName.GA_TAY);
        itemsRecFromCoinItem.add(0.001, ItemName.TOM_HUM);
        itemsRecFromCoinItem.add(0.001, ItemName.HAGGIS);
        itemsRecFromCoinItem.add(0.001, ItemName.LONG_DEN_TRON);
        itemsRecFromCoinItem.add(0.001, ItemName.LONG_DEN_CA_CHEP);
        itemsRecFromCoinItem.add(0.001, ItemName.LONG_DEN_NGOI_SAO);
        itemsRecFromCoinItem.add(0.001, ItemName.LONG_DEN_MAT_TRANG);
        itemsRecFromCoinItem.add(50, ItemName.VIEN_LINH_HON_CAP_1);
        itemsRecFromCoinItem.add(50, ItemName.VIEN_LINH_HON_CAP_2);
        itemsRecFromCoinItem.add(50, ItemName.VIEN_LINH_HON_CAP_3);
        itemsRecFromCoinItem.add(80, ItemName.BUI_LINH_HON);
        itemsRecFromCoinItem.add(1, ItemName.MAT_NA_SUPER_BROLY);
        itemsRecFromCoinItem.add(1, ItemName.MAT_NA_ONNA_BUGEISHA);
        itemsRecFromCoinItem.add(80, ItemName.THONG_LINH_THAO);
        ...
        itemsRecFromGoldItem.add(50, ItemName.HOA_TUYET);
        itemsRecFromGoldItem.add(50, ItemName.PHA_LE);
        itemsRecFromGoldItem.add(50, ItemName.NHAM_THACH_);
        itemsRecFromGoldItem.add(80, ItemName.THE_BAI_KINH_NGHIEM_GIA_TOC_SO);
        itemsRecFromGoldItem.add(80, ItemName.THE_BAI_KINH_NGHIEM_GIA_TOC_TRUNG);
        itemsRecFromGoldItem.add(80, ItemName.DA_CAP_8);
        itemsRecFromGoldItem.add(50, ItemName.DA_CAP_9);
        ...
        itemsRecFromGoldItem.add(0.001, ItemName.TUI_VAI_CAP_3);
        ...
        itemsRecFromGoldItem.add(0.001, ItemName.HOAN_LUONG_CHI_THAO);
        itemsRecFromGoldItem.add(0.001, ItemName.GA_TAY);
        itemsRecFromGoldItem.add(0.001, ItemName.TOM_HUM);
        itemsRecFromGoldItem.add(0.001, ItemName.HAGGIS);
        itemsRecFromGoldItem.add(0.001, ItemName.LONG_DEN_TRON);
        itemsRecFromGoldItem.add(0.001, ItemName.LONG_DEN_CA_CHEP);
        itemsRecFromGoldItem.add(0.001, ItemName.LONG_DEN_NGOI_SAO);
        itemsRecFromGoldItem.add(0.001, ItemName.LONG_DEN_MAT_TRANG);
        ...
        itemsRecFromGoldItem.add(50, ItemName.BUI_LINH_HON);
        itemsRecFromGoldItem.add(1, ItemName.MAT_NA_SUPER_BROLY);
        itemsRecFromGoldItem.add(1, ItemName.MAT_NA_ONNA_BUGEISHA);
